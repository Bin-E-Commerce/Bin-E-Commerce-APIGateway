...
export class AdminRecommendationProxyController {
  ...
  @RequirePermissions(Permission.ADMIN_RECOMMENDATION_ANALYTICS_READ)
  async userActivity(@Req() req: Request, @Res() res: Response): Promise<void> {
    await this.forward(req, res);
  }
  ...
  async updateConfig(@Req() req: Request, @Res() res: Response): Promise<void> {
    await this.forward(req, res);
  }
  ...
  @Get("experiments")
  @RequirePermissions(Permission.ADMIN_RECOMMENDATION_ANALYTICS_READ)
  async experiments(@Req() req: Request, @Res() res: Response): Promise<void> {
    await this.forward(req, res);
  }
