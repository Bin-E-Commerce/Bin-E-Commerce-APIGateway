...
export class SellerProxyController {
    ...
    async proxyUpdateShippingSettings(
        @Req() req: Request,
        @Res() res: Response,
    ): Promise<void> {
        await this.proxyToSeller(req, res);
    ...
    @RequirePermissions(Permission.SELLER_SHIPPING_SETTINGS_MANAGE)
    async proxyCreatePickupAddress(
        @Req() req: Request,
        @Res() res: Response,
    ): Promise<void> {
        await this.proxyToSeller(req, res);
    ...
    @RequirePermissions(Permission.SELLER_SHIPPING_SETTINGS_MANAGE)
    async proxySetDefaultPickupAddress(
        @Req() req: Request,
        @Res() res: Response,
    ): Promise<void> {
        await this.proxyToSeller(req, res);
    ...
    @RequirePermissions(Permission.SELLER_SHIPPING_SETTINGS_MANAGE)
    async proxyUpdatePickupAddress(
        @Req() req: Request,
        @Res() res: Response,
    ): Promise<void> {
        await this.proxyToSeller(req, res);
    ...
    @RequirePermissions(Permission.SELLER_SHIPPING_SETTINGS_MANAGE)
    async proxyDeletePickupAddress(
        @Req() req: Request,
        @Res() res: Response,
    ): Promise<void> {
        await this.proxyToSeller(req, res);
