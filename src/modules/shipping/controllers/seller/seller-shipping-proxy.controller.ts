...
export class SellerShippingProxyController {
    ...
    async createReturn(
        ...
        await this.forward(
            `/api/v1/seller/orders/returns/${returnId}/shipment`,
            request,
            response,
        );
    }
    ...
    async refresh(
        ...
        await this.forward(
            `/api/v1/seller/orders/${orderId}/shipment/refresh`,
            request,
            response,
        );
    }
    ...
    async cancel(
        ...
        await this.forward(
            `/api/v1/seller/orders/${orderId}/shipment/cancel`,
            request,
            response,
        );
    }
    ...
    async advanceDemo(
        ...
        await this.forward(
            `/api/v1/seller/orders/${orderId}/shipment/demo/advance`,
            request,
            response,
        );
    }
    ...
    async label(
        ...
        const result = await this.proxyService.forwardBinary(
            `${this.targetBase}/api/v1/seller/orders/${orderId}/shipment/label`,
            request,
        );
